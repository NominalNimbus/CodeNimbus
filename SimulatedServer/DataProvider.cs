...
using UserCode;
using static DebugService.Classes.Periodicity;
...
namespace SimulatedServer
{
    public class DataProvider : IDataProvider
    {
        ...
        public List<Bar> GetBars(Selection parameters)
        {
            ...
            {
                history = GlobalHelper.CreateSimulated(new SimulatedDataParameters
                {
                    Symbol = parameters.Symbol,
                    DataFeed = parameters.DataFeed,
                    Periodicity = ToPeriodicity(parameters.Timeframe),
                    Interval = parameters.TimeFactor,
                    BarsCount = parameters.BarCount,
                    PriceMax = 1.2,
                    PriceMin = 0.9,
                });
            }
        ...
        private static DebugService.Classes.Periodicity ToPeriodicity(Periodicity timeframe)
        {
            switch (timeframe)
            {
